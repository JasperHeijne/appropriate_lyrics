...
# prop, nums = get_hard_words_from_list(["This is the first example sentence, not too difficult.", 
#                                        "Can you imagine an imaginary menagerie manager imagining managing an imaginary menagerie?",
#                                        "Some hard words: Worcestershire, Supercalifragilisticexpialidocious, Onomatopoeia, Phenomenon, Sesquipedalian"])        
