...
#     proportions_seq, nums_seq = get_hard_words_from_list(snippets, True)
#     end_time = time.time()
#     print(f"Execution time with removal: {end_time - start_time:.2f} seconds")

#     start_time = time.time()
#     proportions_par, nums_par = get_hard_words_parallel(snippets)
#     end_time = time.time()
